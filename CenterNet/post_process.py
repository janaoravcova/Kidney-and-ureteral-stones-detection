...
from utils import _gather_feature, _tranpose_and_gather_feature, flip_tensor
...
def ctdet_decode(hmap, regs, w_h_, K=100, mode='train', ignore_areas=None, frame_id=None):
